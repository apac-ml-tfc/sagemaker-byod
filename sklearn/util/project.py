"""Utilities for interacting with 'ML Project' stacks from notebooks"""
...
#                 param_ssm_names[f"/{project_id}-Project/{role_name}/{s}"] = { "cat": "sandbox", "id": s }
        ...
        for param in response["Parameters"]:
            ...
            if param_spec["cat"] == "shared":
                if param_id == "RawBucket":
                    self.raw_bucket = param["Value"]
                elif param_id == "SandboxBucket":
                    self.sandbox_bucket = param["Value"]
